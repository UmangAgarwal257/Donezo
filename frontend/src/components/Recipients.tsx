...
const Recipients = ({ onBack }: RecipientsProps) => {
  ...
  return (
    <div className="relative flex flex-col gap-12 md:gap-24 w-full min-h-screen overflow-x-hidden">
      <Image
        src="/vector.png"
        alt="hero"
        width={800}
        height={600}
        className="bottom-[-100px] absolute w-full h-full object-cover"
      />
      ...
      <main className="flex flex-col flex-1 justify-start items-center gap-8 md:gap-16 w-full max-w-4xl mx-auto px-4 pt-4 md:pt-8">
        <div className="flex flex-col items-center gap-6 md:gap-10 w-full">
          <h1 className="bg-clip-text bg-gradient-stop bg-gradient-to-br from-white via-30% via-white to-white/30 font-medium text-[32px] md:text-[40px] lg:text-[72px] text-transparent text-center leading-[1.2] md:leading-[1.3]">
            {isRegistered ? 'Your Journey Begins! 🚀' : 'Start Your Growth Journey'}
          </h1>

          <div className="w-full space-y-4 bg-[#b4b2b21a] backdrop-blur-lg p-4 md:p-6 border border-neutral-400 rounded-[20px] md:rounded-[32px]">
              ...
              {!isRegistered ? (
                ...
                >
                  <div className="flex flex-col items-start gap-3 mb-6">
                    <h3 className="text-base md:text-lg font-semibold">Choose Your Mentor Style</h3>
                    <div className="w-full">
                      <select
                        value={selectedTemplate.style}
                        onChange={(e) => setSelectedTemplate(prev => ({ ...prev, style: e.target.value as 'elonMusk' | 'steveJobs' }))}
                        className="w-full bg-[#28282A] px-3 py-2 border border-[#6c6c6c] rounded-lg outline-none text-white text-sm md:text-base"
                      >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div
                      className="flex flex-col md:flex-row gap-4 p-4 border border-neutral-400 rounded-xl backdrop-blur-sm"
                      style={{
                      ...
                      <div className="flex flex-col gap-4 flex-1">
                        <div className="flex items-center gap-3">
                          ...
                          <input
                            ...
                            className="flex-1 bg-[#28282A] px-3 py-2 border-0 rounded-md outline-none placeholder:font-medium text-white placeholder:text-[#9B9A9E] text-sm md:text-base"
                            required
                          />
                        </div>
                        <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <div className="text-center space-y-2">
                    ...
                    <div className="mt-4 md:mt-6 p-3 md:p-4 bg-[#28282A] rounded-lg">
