...
import { AceternityGrid } from './ui/aceternity-grid';
...
const Recipients = ({ onBack }: RecipientsProps) => {
  ...
  return (
    <div className="relative flex flex-col gap-12 md:gap-24 w-full h-screen overflow-y-auto">
      <AceternityGrid />
      <div className="relative z-10 flex flex-col gap-12 md:gap-24 w-full">
        ...
        <main className="flex flex-col flex-1 justify-start items-center gap-8 md:gap-16 w-full max-w-4xl mx-auto px-4 pt-4 md:pt-8 pb-12">
          <div className="flex flex-col items-center gap-6 md:gap-10 w-full">
            ...
            <div className="w-full space-y-4 bg-[#1a1a1a]/80 backdrop-blur-sm p-4 md:p-6 border border-neutral-800 rounded-[20px] md:rounded-[32px]">
                ...
                {!isRegistered ? (
                  ...
                  >
                    <div className="flex flex-col items-start gap-3 mb-6">
                      ...
                      <div className="w-full">
                        <select
                          ...
                          className="w-full bg-[#2a2a2a]/90 backdrop-blur-sm px-3 py-2 border border-neutral-700 rounded-lg outline-none text-white text-sm md:text-base"
                        >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="flex flex-col md:flex-row gap-4 p-4 border border-neutral-700 rounded-xl bg-[#1f1f1f]/80 backdrop-blur-sm">
                        <div className="flex flex-col gap-4 flex-1">
                          <div className="flex items-center gap-3">
                            ...
                            <input
                              ...
                              className="flex-1 bg-[#2a2a2a]/90 backdrop-blur-sm px-3 py-2 border-0 rounded-md outline-none text-white placeholder:text-neutral-500 text-sm md:text-base"
                              required
                            />
                          </div>
                          <div className="flex items-center gap-3">
                  ...
                  >
                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-green-500/20 backdrop-blur-sm flex items-center justify-center">
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <div className="mt-4 md:mt-6 p-3 md:p-4 bg-[#2a2a2a]/90 backdrop-blur-sm rounded-lg">
